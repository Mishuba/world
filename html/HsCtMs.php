...
<head>
    ...
    <meta name="author" content="Mishuba Feilong" />
    <meta name="description" content="A yo mishuba use this to go live from your phone without using a third party app" />
    <style>
        body {
		border: 0%;
...
//		facingMode: whichCamera ? "user" || "environment" || "left" || "right"
	},
    };
	...
	const startStreamUrl  = "https://world.tsunamiflow.club/mishubalive.php";
    ...
    document.getElementById('updateMetadataForm').addEventListener('submit', async 
(e) => {
        e.preventDefault();
        ...
        await fetch('https://world.tsunamiflow.club/mishubalive.php', {
            method: 'POST',
    ...
    async function loadDestinations() {
        const res = await fetch('https://world.tsunamiflow.club/mishubalive.php');
